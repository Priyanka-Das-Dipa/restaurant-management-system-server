...
console.log(process.env.STRIPE_SECRET_API);
...
async function run() {
  try {
    ...
    app.post("/payments", async (req, res) => {
      ...
      mg.messages
        .create(process.env.MAIL_SENDING_DOMAIN , {
          from: "Mailgun Sandbox <postmaster@sandbox0126ae887c11483baf81a967a428bff0.mailgun.org>",
          to: ["priyankadipa9102@gmail.com"],
          subject: "Bistro Order Conformation",
          text: "Testing some Mailgun awesomness!",
          html: `
          <div>
            <h2>Thank You for your Order</h2>
            <h4>YOur Transition id is: ${payment.transionId} </h4>
          </div>
          `,
        })
    ...
    // from chart and graph create and get order-stats
